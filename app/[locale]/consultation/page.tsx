        ...
        >
            <div className="max-w-2xl m-auto">
                <p className="text-gray-700">
                    ...
                    предлагая вам индивидуальную консультацию и поддержку на этапе
                    открытие.
                </p>
                ...
                <div>
                    ...
                    <div className="text-gray-700 mt-3">
                        <ul>
                            <ListItem listType="ul">
                                ...
                                идея открыть кофейню? Если вы любите кофе и видите
                                себя в роли хозяина уютного заведения, то это
                            ...
                            <ListItem listType="ul">
                                ...
                                возможности для развития? Открыть кофейню – отличный
                    ...
                    <h2 className="text-center">
                        Как происходит процесс консультации
                    </h2>
                    <p className="leading-loose">
                        Мы назначаем встречу в Киеве в договоренном месте и
                        назначенное времени, удобное для вас и нас. Мы проводим
                        консультацию отвечая на все ваши вопросы, раскажем вам свой
                        опыт и нюансы в кофеном бизнесе. В среднем консультация может
                        занят 2-3 часа времени.
                    </p>
                    <p className="leading-loose">
                        Нам важно что бы после консультации вы открыли успешное
                        заведение. Так же вы получите базовый бизнес план, список
                        надежнных поставщиков и онлайн поддержку в зависимости от
                        тарифа.
                    </p>
                    <p className="leading-loose">
                        ...
                        <Link
                            ...
                            href={'/turnkey'}
                        >
                            открытия кофейни под ключ
                        </Link>{' '}
                        это совсем другая услуга.
                    </p>
                    <h2 className="text-center">
                    ...
                    <div className="text-gray-700 mt-3">
                        <p className="leading-loose">
                            Консультация по открытию кофейни это наш ценный опыт,
                            наши ошибки которые мы совершли. Мы составили список тем
                            которые будут обсуждатся на консультации:
                        </p>
                        <ol>
