...
const Contact = () => {
    return (
        <PageWrapper header="Контакты">
            <div className="flex flex-wrap -mx-4 mt-7 lg:justify-between">
                    ...
                    <div className="mb-12 max-w-[570px] lg:mb-0">
                        ...
                        <div className="mb-8 flex w-full max-w-[370px]">
                            <div className="w-full">
                                ...
                                <a href="tel:+">+380930624266</a>
                                <div className="mt-3 flex items-center gap-x-7 text-xl">
                                    <FaTelegramPlane className="text-indigo-400" />
                                    <FaViber className="text-indigo-400" />
                                </div>
                            </div>
                        </div>
                        <div className="mb-8 flex w-full max-w-[370px]">
                            <div className="w-full">
                                ...
                                <a
                                    ...
                                    href="mailto:openkava@gmail.com"
                                >
                                    openkava@gmail.com
                                </a>
                            </div>
                ...
                <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                    <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                        ...
                        <div>
                            <span className="hidden md:block absolute -top-10 -right-9 z-[-1]">
                                <svg
                                    width={100}
                                    height={100}
                                    viewBox="0 0 100 100"
                            ...
                            <span className="hidden md:block absolute -right-10 top-[90px] z-[-1]">
                                <svg
                                    width={34}
                                    height={134}
                                    viewBox="0 0 34 134"
                            ...
                            <span className="hidden md:block absolute -left-7 -bottom-7 z-[-1]">
                                <svg
                                    width={107}
                                    height={134}
                                    viewBox="0 0 107 134"
